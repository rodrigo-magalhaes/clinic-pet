...
public class VisitController {
    ...
    private static final String VIEWS_VISIT_CREATE_OR_UPDATE = "pets/createOrUpdateVisitForm";
    ...
    public String initNewVisitForm(@PathVariable("petId") Long petId, Model model) {
        return VIEWS_VISIT_CREATE_OR_UPDATE;
    }
    ...
    public String processNewVisitForm(@Valid Visit visit, BindingResult result) {
        if (result.hasErrors()) {
            ...
            return VIEWS_OWNER_REDIRECT+visit.getPet().getOwner().getId();
        }
    }
}
